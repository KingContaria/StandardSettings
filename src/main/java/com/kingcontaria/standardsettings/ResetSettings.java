            ...
            while ((string = bufferedReader.readLine()) != null) {
                try {
                    ...
                    switch (string0_split[0]){
                        ...
                        case "renderClouds":
                            switch (strings[1]){
                                case "true": options.cloudMode = 2; break;
                                case "false": options.cloudMode = 0; break;
                                case "fast": options.cloudMode = 1; break;
                            } break;
                        ...
                        */
                        ...
                        case "entityShadows": options.entityShadows = strings[1].equals("true"); break;
