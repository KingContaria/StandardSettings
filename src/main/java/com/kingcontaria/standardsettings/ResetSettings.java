            ...
            for (String string2 : compoundTag2.getKeys()) {
                ...
                try {
                    ...
                    if ("forceUnicodeFont".equals(string2)) {
                        ...
                        ((PieChartAccessor)client).callInitFont(Boolean.parseBoolean(string22));
                    }
                    ...
                    if ("darkMojangStudiosBackground".equals(string2)) {
                        client.options.monochromeLogo = Boolean.parseBoolean(string22);
                    }
                    ...
                    if ("screenEffectScale".equals(string2)) {
                        client.options.distortionEffectScale = Float.parseFloat(string22);
                    }
                    if ("fovEffectScale".equals(string2)) {
                        client.options.fovEffectScale = Float.parseFloat(string22);
                    }
                    ...
                    if ("ao".equals(string2)) {
                        client.options.ao = AoMode.byId((int) Float.parseFloat(string22));
                    }
                    ...
                    */
                    ...
                    if ("narrator".equals(string2)) {
                        client.options.narrator = NarratorMode.byId(Integer.parseInt(string22));
                    }
                    ...
                    for (PlayerModelPart playerModelPart : PlayerModelPart.values()) {
                        ...
                        client.options.togglePlayerModelPart(playerModelPart, "true".equals(string22));
                    }
