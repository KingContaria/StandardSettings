...
public class StandardSettings {
            ...
            while ((string = bufferedReader.readLine()) != null) {
                ...
                try {
                    switch(string0_split[0]){
                        ...
                        case "ao" -> options.ao = AoMode.byId((int) Float.parseFloat(strings[1]));
                        ...
                        case "rawMouseInput" -> {
                            ...
                            window.setRawMouseMotion(options.rawMouseInput);
                        }
    ...
    public static void changeSettingsOnJoin(){
        ...
        if(simulationDistanceOnWorldJoin != 0){
            Option.SIMULATION_DISTANCE.set(options,(options.simulationDistance = simulationDistanceOnWorldJoin));
        }
